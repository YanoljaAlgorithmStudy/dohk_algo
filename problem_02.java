...
public class problem_02 {
    public static String Solution(int[] numbers, String hand){
        ...
        for(int num : numbers) {
            if (leftDistance.get(num) < rightDistance.get(num)) {
                currentLeft = num;
                answer += "L";
                leftDistance = setLeftDistance(currentLeft, leftDistance);
            }
            else if (leftDistance.get(num) > rightDistance.get(num)) {
                currentRight = num;
                answer += "R";
                rightDistance = setRightDistance(currentRight, rightDistance);
            }
            else { // leftDistance.get(num) == rightDistance.get(num)
                if (hand == "left") {
                    currentLeft = num;
                    answer += "L";
                    leftDistance = setLeftDistance(currentLeft, leftDistance);
    ...
    public static Map<Integer, Integer> setLeftDistance(int currentPosition, Map<Integer, Integer> distanceMap) {
        //L*=R#: {2:4, 5:3, 8:2, 0:0 or inf}
        //L1=R3: {2:1, 5:2, 8:3, 0:4}
        //L2=R2: {2:0, 5:1, 8:2, 0:3}
        //L4=R6: {2:2, 5:1, 8:2, 0:3}
    ...
    public static Map<Integer, Integer> setRightDistance(int currentPosition, Map<Integer, Integer> distanceMap) {
        //L*=R#: {2:4, 5:3, 8:2, 0:0 or inf}
        //L1=R3: {2:1, 5:2, 8:3, 0:4}
        //L2=R2: {2:0, 5:1, 8:2, 0:3}
        //L4=R6: {2:2, 5:1, 8:2, 0:3}
...
//        String hand_2 = "left";
        ...
        String answer = Solution(numbers_3, hand_3);
